...
class VaultStatsModel1Y {
  VaultStatsModel1Y({
    ...
    this.vaultStatsModelGraph1Y,
    this.collectible,
    this.comic,
  });

  VaultStatsModel1Y.fromJson(dynamic json) {
    ...
    if (json['graph'] != null) {
      vaultStatsModelGraph1Y = [];
      json['graph'].forEach((v) {
        vaultStatsModelGraph1Y?.add(VaultStatsModelGraph1Y.fromJson(v));
      });
    }
  }
  ...
  List<VaultStatsModelGraph1Y>? vaultStatsModelGraph1Y;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (vaultStatsModelGraph1Y != null) {
      map['graph'] = vaultStatsModelGraph1Y?.map((v) => v.toJson()).toList();
    }
    return map;
  }
}

class VaultStatsModelGraph1Y {
  VaultStatsModelGraph1Y({
    this.hour,
    this.total,
    this.inHour,
  ...
  VaultStatsModelGraph1Y.fromJson(dynamic json) {
    hour = json['hour'];
    total = json['total'];
