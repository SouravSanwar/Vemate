...
class HomeVaultModel7D {
  HomeVaultModel7D({
    ...
    this.homeVaultModelGraph7D,
    this.collectible,
    this.comic,
  });

  HomeVaultModel7D.fromJson(dynamic json) {
    ...
    if (json['graph'] != null) {
      ...
      json['graph'].forEach((v) {
        homeVaultModelGraph7D?.add(HomeVaultModelGraph7D.fromJson(v));
      });
    }
  }
  ...
  List<HomeVaultModelGraph7D>? homeVaultModelGraph7D;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (HomeVaultModelGraph7D != null) {
      map['graph'] = homeVaultModelGraph7D?.map((v) => v.toJson()).toList();
    }
    return map;
  }
}

class HomeVaultModelGraph7D {
  HomeVaultModelGraph7D({
    this.hour,
    this.total,
    this.inHour,
  ...
  HomeVaultModelGraph7D.fromJson(dynamic json) {
    hour = json['hour'];
    total = json['total'];
