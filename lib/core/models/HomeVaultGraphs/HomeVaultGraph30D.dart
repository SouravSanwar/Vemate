...
class HomeVaultModel30D {
  HomeVaultModel30D({
    ...
    this.homeVaultModelGraph30D,
    this.collectible,
    this.comic,
  });

  HomeVaultModel30D.fromJson(dynamic json) {
    ...
    if (json['graph'] != null) {
      ...
      json['graph'].forEach((v) {
        homeVaultModelGraph30D?.add(HomeVaultModelGraph30D.fromJson(v));
      });
    }
  }
  ...
  List<HomeVaultModelGraph30D>? homeVaultModelGraph30D;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (HomeVaultModelGraph30D != null) {
      map['graph'] = homeVaultModelGraph30D?.map((v) => v.toJson()).toList();
    }
    return map;
  }
}

class HomeVaultModelGraph30D {
  HomeVaultModelGraph30D({
    this.hour,
    this.total,
    this.inHour,
  ...
  HomeVaultModelGraph30D.fromJson(dynamic json) {
    hour = json['hour'];
    total = json['total'];
