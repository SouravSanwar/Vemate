...
class HomeVaultModel1Y {
  HomeVaultModel1Y({
    ...
    this.homeVaultModelGraph1Y,
    this.collectible,
    this.comic,
  });

  HomeVaultModel1Y.fromJson(dynamic json) {
    ...
    if (json['graph'] != null) {
      ...
      json['graph'].forEach((v) {
        homeVaultModelGraph1Y?.add(HomeVaultModelGraph1Y.fromJson(v));
      });
    }
  }
  ...
  List<HomeVaultModelGraph1Y>? homeVaultModelGraph1Y;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (HomeVaultModelGraph1Y != null) {
      map['graph'] = homeVaultModelGraph1Y?.map((v) => v.toJson()).toList();
    }
    return map;
  }
}

class HomeVaultModelGraph1Y {
  HomeVaultModelGraph1Y({
    this.hour,
    this.total,
    this.inHour,
  ...
  HomeVaultModelGraph1Y.fromJson(dynamic json) {
    hour = json['hour'];
    total = json['total'];
