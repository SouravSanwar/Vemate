...
class HomeVaultModel60D {
  HomeVaultModel60D({
    ...
    this.homeVaultModelGraph60D,
    this.collectible,
    this.comic,
  });

  HomeVaultModel60D.fromJson(dynamic json) {
    ...
    if (json['graph'] != null) {
      ...
      json['graph'].forEach((v) {
        homeVaultModelGraph60D?.add(HomeVaultModelGraph60D.fromJson(v));
      });
    }
  }
  ...
  List<HomeVaultModelGraph60D>? homeVaultModelGraph60D;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (HomeVaultModelGraph60D != null) {
      map['graph'] = homeVaultModelGraph60D?.map((v) => v.toJson()).toList();
    }
    return map;
  }
}

class HomeVaultModelGraph60D {
  HomeVaultModelGraph60D({
    this.hour,
    this.total,
    this.inHour,
  ...
  HomeVaultModelGraph60D.fromJson(dynamic json) {
    hour = json['hour'];
    total = json['total'];
