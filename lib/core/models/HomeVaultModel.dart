...
class HomeVaultModel {
  HomeVaultModel({
    ...
    this.homeVaultModelGraph,
    this.collectible,
    this.comic,
  });

  HomeVaultModel.fromJson(dynamic json) {
    ...
    if (json['graph'] != null) {
      ...
      json['graph'].forEach((v) {
        homeVaultModelGraph?.add(HomeVaultModelGraph.fromJson(v));
      });
    }
  }
  ...
  List<HomeVaultModelGraph>? homeVaultModelGraph;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (HomeVaultModelGraph != null) {
      map['graph'] = homeVaultModelGraph?.map((v) => v.toJson()).toList();
    }
    return map;
  }
}

class HomeVaultModelGraph {
  HomeVaultModelGraph({
    this.hour,
    this.total,
    this.inHour,
  ...
  HomeVaultModelGraph.fromJson(dynamic json) {
    hour = json['hour'];
    total = json['total'];
