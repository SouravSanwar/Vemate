...
class OneDayProductGraphPage extends StatefulWidget {
  ...
  const OneDayProductGraphPage({Key? key, this.fromVault, this.ap}) : super(key: key);
          ...
          child: data.oneDayGraphModel != null
            ...
            axes: [
              NumericAxis(
                  ...
                  double.parse(detailsAp!) > maxPriceOneDayGraph!
                      ? double.parse(detailsAp!) + (double.parse(detailsAp!)*.1)
                      : maxPriceOneDayGraph!+(maxPriceOneDayGraph!*.2)
                      :null,
