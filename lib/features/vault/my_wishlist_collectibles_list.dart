...
class MyWishlistCollectiblesLists extends StatefulWidget {
  ...
  @override
  State<MyWishlistCollectiblesLists> createState() => _MyWishlistCollectiblesListsState();
}

class _MyWishlistCollectiblesListsState extends State<MyWishlistCollectiblesLists> {
  int offset = 0;
