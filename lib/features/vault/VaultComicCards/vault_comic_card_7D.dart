...
class VaultComicsCard7D extends StatefulWidget {
  final Comic? data;

  const VaultComicsCard7D({Key? key, this.data}) : super(key: key);

  @override
  State<VaultComicsCard7D> createState() => _VaultComicsCard7DState();
}

class _VaultComicsCard7DState extends State<VaultComicsCard7D> {
  @override
