...
class VaultComicsCard1Y extends StatefulWidget {
  final Comic? data;

  const VaultComicsCard1Y({Key? key, this.data}) : super(key: key);

  @override
  State<VaultComicsCard1Y> createState() => _VaultComicsCard1YState();
}

class _VaultComicsCard1YState extends State<VaultComicsCard1Y> {
  @override
