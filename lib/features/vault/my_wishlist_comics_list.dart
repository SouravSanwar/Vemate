...
class MyWishlistComicsLists extends StatefulWidget {
  const MyWishlistComicsLists({Key? key}) : super(key: key);

  @override
  State<MyWishlistComicsLists> createState() => _MyWishlistComicsListsState();
}

class _MyWishlistComicsListsState extends State<MyWishlistComicsLists> {
  int offset = 0;
                  ...
                  data.wishListModel!.results![index].productDetail!.type==1
                    ...
                    onTap: () {
                      ...
                      data.wishListModel!.results![index].productDetail!.type == 0
                          ...
                          : Get.to(() => ComicDetails(
                        productId:
                        data.wishListModel!.results![index].productDetail!.id!,
                      ));
                    },
                    child: Padding(
                                    ...
                                    Expanded(
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          if (data.wishListModel!.results![index]
                                              .productDetail!
                                              .priceChangePercent!
                                              .sign ==
                                              'decrease')
