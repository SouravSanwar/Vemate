...
class VaultCollectiblesCard7D extends StatefulWidget {
  final Collectible? data;

  const VaultCollectiblesCard7D({Key? key, this.data}) : super(key: key);

  @override
  State<VaultCollectiblesCard7D> createState() => _VaultCollectiblesCard7DState();
}

class _VaultCollectiblesCard7DState extends State<VaultCollectiblesCard7D> {
  @override
