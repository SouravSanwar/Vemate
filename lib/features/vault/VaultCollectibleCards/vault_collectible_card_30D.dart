...
class VaultCollectiblesCard30D extends StatefulWidget {
  final Collectible? data;

  const VaultCollectiblesCard30D({Key? key, this.data}) : super(key: key);

  @override
  State<VaultCollectiblesCard30D> createState() => _VaultCollectiblesCard30DState();
}

class _VaultCollectiblesCard30DState extends State<VaultCollectiblesCard30D> {
  @override
