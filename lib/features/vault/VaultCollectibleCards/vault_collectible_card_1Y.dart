...
class VaultCollectiblesCard1Y extends StatefulWidget {
  final Collectible? data;

  const VaultCollectiblesCard1Y({Key? key, this.data}) : super(key: key);

  @override
  State<VaultCollectiblesCard1Y> createState() => _VaultCollectiblesCard1YState();
}

class _VaultCollectiblesCard1YState extends State<VaultCollectiblesCard1Y> {
  @override
