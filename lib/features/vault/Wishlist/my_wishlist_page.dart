                                        ...
                                        children: <Widget>[
                                          Container(
                                              ...
                                              child: data.wishListModel!.results![index].productDetail!.image == null
                                                  ? FirstLetterImage(
                                                      firstLetter: data
                                                          .wishListModel!.results![index].productDetail!.name
                                                          .toString()[0]
                                                          .toUpperCase(),
                                                      fontsize: 35,
                                                    )
                                                  : data.wishListModel!.results![index].productDetail!.image!
                                                              .low_res_url ==
                                                          null
                                                      ? VeVeLowImage(
                                                          imageUrl: data.wishListModel!.results![index].productDetail!
                                                              .image!.image_on_list
                                                              .toString(),
                                                        )
                                                      : VeVeLowImage(
                                                    ...
                                                    series: <ChartSeries<Graph, String>>[
                                                      LineSeries<Graph, String>(
                                                        color: data.wishListModel!.results![index].productDetail!
                                                            ...
                                                            ? Colors.red
                                                            : Colors.green,
                                                        dataSource: data.wishListModel!.results![index].productDetail!
                                                            .graphData!.graph!,
