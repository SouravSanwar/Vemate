...
class StudioProductSearch extends StatefulWidget {
  @override
  _StudioProductSearchState createState() => _StudioProductSearchState();
}

class _StudioProductSearchState extends State<StudioProductSearch> {
                    ...
                    return InkWell(
                      onTap: () {
                        Get.to(
                          ...
                          arguments: data
                              .searchCollectiblesModel!.results![index],
                        );
                      },
                      child: Padding(
